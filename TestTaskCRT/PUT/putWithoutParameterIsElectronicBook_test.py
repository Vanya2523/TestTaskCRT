...
#Обновление без параметра isElectronicBook
def test_putWithoutParameterIsElectronicBook(BaseFile=BaseFile):
    ...
    payload = {"name": "Капитанская дочка", "author": "Александр Пушкин", "year": 1838}
