...
#Обновление без параметра year
def test_putWithoutParameterYear(BaseFile=BaseFile):
    ...
    payload = {"name": "Капитанская дочка", "author": "Александр Пушкин","isElectronicBook": False}
